      ...
      <div className="min-h-screen bg-[#0D1B2A] text-white flex flex-col">
        <header className="border-b border-white/10 bg-[#0D1B2A]/95 px-4 py-3">
          <div className="max-w-7xl mx-auto flex items-center justify-between">
            <Image src="/logo-white.png" alt="accredit.vip" width={240} height={44} className="h-10 w-auto object-contain" />
      ...
      <header className="border-b border-white/10 bg-[#0D1B2A]/95 sticky top-0 z-30">
        <div className="max-w-7xl mx-auto px-4 py-3 flex items-center justify-between gap-3">
          <div className="flex items-center gap-3 min-w-0">
            <Image src="/logo-white.png" alt="accredit.vip" width={240} height={44} className="h-10 w-auto object-contain flex-shrink-0" />
            {selectedEvent && (
